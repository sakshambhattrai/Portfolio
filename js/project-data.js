...
const projectData = [
    {
        ...
        fullDesc: `
            ...
            <ul class="list-disc pl-5 space-y-2 text-slate-700 dark:text-slate-300">
                <li><strong>Coil Winding & Assembly:</strong> Custom wound stators with 50 parallel turns of 24 AWG wire in a Wye termination. Addressed high winding resistance by winding in parallel.</li>
                <li><strong>Mechanical Design:</strong> Implemented a free-floating dual bearing design with steel screws serving as the shaft and stator inserts, reducing friction for smooth sensor-less startup. Components were 3D printed using High Temperature PLA.</li>
                <li><strong>Testing & Tuning:</strong> Overcame initial synchronization problems caused by high coil inductance by tuning the ESC parameters, successfully achieving functional motor spin.</li>
            </ul>
        `,
        techSpecs: [
            { label: "Configuration", value: "9S24P, Wye Termination" },
            { label: "Materials", value: "High Temp PLA, Neodymium, Copper" },
            { label: "Role", value: "Soldering, ESC Tuning, Assembly" }
        ],
        media: `
